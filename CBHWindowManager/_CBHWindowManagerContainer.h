...
@property (nonatomic, readonly) NSValue *windowKey;
@property (nonatomic, readonly, nullable) NSValue *controllerKey;
@property (nonatomic, readonly, nullable) NSString *key;

@property (nonatomic, readonly) BOOL shouldReleaseOnClose;
